...
class MyPlugin implements PluginInterface
{
    ...
    {
        // In this method, youc an see that the plugin creates a parent nav bar (PluginParent), and then it creates 3 children nested under the nav bar. 
        global $navItems;
    ...
    public function addNavItemToHome(){
        // Very similar to the addNavItemsWithChildren but this time, itt will add a nested item nav item under the "home" parent. 
        global $navItems;
    ...
    public function addNavItemToAboutUs(){
        // If you wanted to add some children to the "about us" tab for example, you can loop through the labels and find the about us label,
